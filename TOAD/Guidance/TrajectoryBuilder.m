...
Waypoints(4) = TOADWaypoint([7; 7; 15], 'Label', 'FLT HOV 2', 'PosTol', [2; 2; 3], ...
    'MaxVel', [3; 3; 6], 'VelFF', [0; 0; -3]);

Waypoints(5) = TOADWaypoint([7; 7; 0], 'Label', 'FLT END 1', 'PosTol', [3; 3; 0.5], ...
    'HoldTime', 1, 'MaxVel', [3; 3; 3], 'VelFF', [0; 0; -0.1]);