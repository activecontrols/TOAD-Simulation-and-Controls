...
constantsSTADPOLE.init_cond = [1e-6; 1e-6; 1e5; 1e5; 1e5; 1e5; 1e5]; % initial conditions for fluid mechanics
...
constantsSTADPOLE.d_coeff_fu = 0.73; % [unitless], Random value just to get the code to run
