...
constantsOX.dens = 1141; % [kg/m^3], liquid oxygen density, at 90 K and 1 atm
constantsOX.coeff = 0.65; % [unitless], Random value just to get the code to run
constantsOX.area = 3E-05; % [m^2], Random value just to get the code to run
constantsFU.dens = 786; % [kg/m^3], fuel density, at 293 K and 1 atm
constantsFU.coeff = 0.65; % [unitless], Random value just to get the code to run
constantsFU.area = 3E-05; % [m^2], Random value just to get the code to run
